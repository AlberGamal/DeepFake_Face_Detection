...
"# DeepFake_Face_Detection"  git init git add . git commit -m "first commit" git branch -M main git remote add origin https://github.com/AlberGamal/DeepFake_Face_Detection.git git push -u origin main
